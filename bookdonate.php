...
$query2 = "INSERT into book_form (Full_name,Login_email,Address,Country,book_type,quantity,donation_type,receiver_email,user_id)
VALUES ('$fname','$username','$house.$city.$state.$pincode','$country','$bd','$quantity','$dt','$email','$id')";
        $result1 = mysqli_query($conn,$query2);

        if($result1){
            echo "<div class='form'>
<h3>Your Donation Form has been successfully submitted. Your donated books will be soon collected by the NGO or some individual. Thank You for donating!! </h3>
</div>";    
   }
    }else{
?>
...
<form id ="registration" action="" method="post">
 <h2 style="left:23%;">Book Details</h2> 
...
Address for Book Collection:<br>
...
Select Board: &nbsp&nbsp
<input type="checkbox" name="bd" id="bd" value="SSC"> SSC<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<input type="checkbox" name="bd" id="bd" value="CBSE"> CBSE<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<input type="checkbox" name="bd" id="bd" value="CBSE"> ICSE<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<input type="checkbox" name="bd" id="bd" value="Other">Other<br><br>


No. of Books: &nbsp&nbsp&nbsp<input type="number" name="quantity" id="button" size="5" placeholder="" required><br><br>
