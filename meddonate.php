...
$query2 = "INSERT into medicine_form (Full_name,Login_email,Address,Country,brand_name,generic_name,quantity,expiry_date,medicine_type,donation_type,receiver_email,user_id)
...
Brand Name: &nbsp&nbsp<input type="text" name="brand" id="button" placeholder="" size="35" required><br><br>

Generic Name:&nbsp<input type="text" name="generic" id="button" placeholder="" size="35" required><br><br>

Quantity: &nbsp&nbsp&nbsp<input type="number" name="quantity" id="button" size="5" placeholder="" required><br><br>

Expiry Date: &nbsp&nbsp&nbsp <input type="Date" name="expiry" id="button" placeholder="" size="35" required><br><br>
