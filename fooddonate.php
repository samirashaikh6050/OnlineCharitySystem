...
$query2 = "INSERT into food_form (Full_name,Login_email,Address,Country,food_item,quantity,donation_type,receiver_email,user_id)
VALUES ('$fname','$username','$house.$city.$state.$pincode','$country','$item','$quantity','$dt','$email','$id')";
        $result1 = mysqli_query($conn,$query2);

        if($result1){
            echo "<div class='form'>
<h3>Your Donation Form has been successfully submitted. Your donated food will be soon collected by the NGO or some individual. Thank You for donating!! </h3>
</div>";    
   }
    }else{
?>
...
<form id ="registration" action="" method="post">
 <h2 style="left:23%;">Food Details</h2> 
...
Address for Food Collection:<br>
...
Select Items: &nbsp&nbsp<input type="checkbox" name="item" id="item" value="Rice"> Rice<br> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             &nbsp&nbsp<input type="checkbox" name="item" id="item" value="Wheat"> Wheat<br>
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             &nbsp&nbsp<input type="checkbox" name="item" id="item" value="Cereal"> Cereal<br>
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             &nbsp&nbsp<input type="checkbox" name="item" id="item" value="Fruits"> Fruits<br>
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
             &nbsp&nbsp<input type="checkbox" name="item" id="item" value="Other"> Others<br><br>


Quantity in kg: &nbsp&nbsp&nbsp<input type="number" name="quantity" id="button" size="5" placeholder="" required><br><br>
